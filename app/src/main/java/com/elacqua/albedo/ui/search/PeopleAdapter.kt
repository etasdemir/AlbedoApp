...
class PeopleAdapter(private val listener: OnSearchSelected<People>) : SearchRecyclerAdapter<People>(){
    ...
    inner class ViewHolder(private val view: View): SearchViewHolder(view){
        override fun onBind(position: Int){
            ...
            view.txt_search_recycler_people_alias.text = dataList[position].alternativeNames.toString()
